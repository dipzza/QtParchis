...
public:
    ...
    Q_INVOKABLE static int getXCoordinate(Color color, int board_position, int idx);
    Q_INVOKABLE static int getYCoordinate(Color color, int board_position, int idx);
